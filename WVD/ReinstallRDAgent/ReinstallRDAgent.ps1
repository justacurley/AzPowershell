...
'@ -replace "\(replacewithtoken\)",$RegInfo.Token | set-content -path .\script.ps1 -force

$Result = Invoke-AzVMRunCommand -ResourceGroupName $VMResourceGroupName -VMName $VMName -CommandId RunPowerShellScript -ScriptPath .\script.ps1 -Verbose
